...
public class _00_2DArrayDemo {
	public static void main(String[] args) {
		/*
		 * A two-dimensional array is simply an array of arrays. The syntax for a two
		 * dimensional array is two square brackets [][] int[][] array2D = { {1, 2, 3},
		 * {4, 5, 6}, {7, 8, 9,} };
		 *
		 * array2D[0] is the array {1, 2, 3} array2D[1] is the array {4, 5, 6}
		 * array2D[2] is the array {7, 8, 9}
		 *
		 * For row 1: array2D[1][0] is the number 4 array2D[1][1] is the number 5
		 * array2D[1][2] is the number 6
		 *
		 * For column 0: array2D[0][0] is the number 1 array2D[1][0] is the number 4
